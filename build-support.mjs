...
export function getBuild(root) {
  ...
  if(!['3.20.7','3.20.11','3.20.17','3.20.21','3.20.23','3.21.1','3.21.9','3.21.12','3.21.13','3.21.16','3.21.18'].includes(version))throw new Error('Unsupported Cursor version: '+version);
